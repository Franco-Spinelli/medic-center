        ...
        List<PatientDTO>patientDTOList = patientService.findAll().stream()
                .map(patient -> PatientDTO.builder()
                        ...
                        .medicalRecord(MedicalRecordDTO.builder()
                                ...
                                .vaccinationRecord(patient.getMedicalRecord().getVaccinationRecord())
                                .currentMedications(patient.getMedicalRecord().getCurrentMedications())
                                .previousIllnesses(patient.getMedicalRecord().getPreviousIllnesses()).build())
